    ...
    <body>
        ...
        <div id="big_wrapper">            
             <form name="admin" action="Controller" method="post">
                ...
                <center>      <br /><h3> Selecione um produto para remover </h3> <br />  
                    ...
                    Nome &nbsp; <input type="radio" name="admin_radio_delete" value="name" /> <br />  <br />                    
                    Id/Nome <input type="text" name="admin_id_ou_nome" />
